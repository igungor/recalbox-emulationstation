...
res2hMapType::value_type mapTemp[] = {
    ...
    std::make_pair(":/fontawesome_webfont.ttf", res2hFiles[22]),
    ...
    std::make_pair(":/help/button_hotkey.svg", res2hFiles[40]),
    std::make_pair(":/help/button_l2.svg", res2hFiles[41]),
    std::make_pair(":/help/button_l3.svg", res2hFiles[42]),
